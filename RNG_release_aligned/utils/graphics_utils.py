...
def getWorld2View2_cu(R, t, translate=None, scale=1.0):
    ...
    if translate is None:
        translate = torch.zeros(3, dtype=R.dtype, device=R.device)
    elif not torch.is_tensor(translate):
        translate = torch.tensor(translate, dtype=R.dtype, device=R.device)
    else:
        translate = translate.to(dtype=R.dtype, device=R.device)
