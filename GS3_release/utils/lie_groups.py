# Copied from https://github.com/nerfstudio-project/nerfstudio/blob/main/nerfstudio/cameras/lie_groups.py
...
def exp_map_SO3xR3(tangent_vector: Float[torch.Tensor, "b 6"]) -> Float[torch.Tensor, "b 3 4"]:
...
# noinspection PyPep8Naming
def exp_map_SE3(tangent_vector: Float[torch.Tensor, "b 6"]) -> Float[torch.Tensor, "b 3 4"]:
