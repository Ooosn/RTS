...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        return color, radii, invdepths, final_T
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, shadow = None):
